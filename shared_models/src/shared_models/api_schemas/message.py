...
class MessageBase(BaseSchema):
    user_id: int
    assistant_id: UUID
    role: str = Field(..., description="Role of the message sender (e.g., 'user', 'assistant', 'system', 'tool_request', 'tool_response')")
    content: str
    content_type: str = Field(default='text', description="Content type of the message (e.g., 'text', 'json')")
    tool_call_id: Optional[UUID] = None
    status: str = Field(default='active', description="Status of the message (e.g., 'active', 'summarized', 'archived', 'error')")
