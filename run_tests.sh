...
print_help() {
    ...
    echo "Available services: rest_service, cron_service, telegram_bot_service, assistant_service"
    exit 1
}
...
all_services=("rest_service" "cron_service" "telegram_bot_service" "assistant_service" "google_calendar_service")
