...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_messages_tool_call_id"), "messages", ["tool_call_id"], unique=False
    )
    op.create_index(op.f("ix_messages_user_id"), "messages", ["user_id"], unique=False)
    op.create_index(
        "ix_messages_user_id_assistant_id_id",
        "messages",
        ["user_id", "assistant_id", "id"],
        unique=False,
    )
    op.create_foreign_key(
        None, "user_summaries", "messages", ["last_message_id_covered"], ["id"]
    )
