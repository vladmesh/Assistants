...
## ЗАМЕТКИ ДЛЯ ДАЛЬНЕЙШЕГО РАСШИРЕНИЯ КОНТЕКСТА

Этот раздел будет пополняться по мере работы над проектом:
...
### Сценарий 1: Обновление списка задач планировщиком

#### Описание процесса
1. Планировщик (cron_service) каждую минуту проверяет наличие новых задач
2. Происходит синхронизация с REST-сервисом
3. Обновляется локальный список задач
4. Проверяется статус существующих задач

#### Логи процесса
```
13:19:00 - scheduler - INFO - Начинаем обновление списка задач из REST-сервиса...
13:19:00 - scheduler - INFO - REST_SERVICE_URL: http://rest_service:8000
13:19:00 - rest_client - INFO - Получено задач: 0
13:19:00 - scheduler - INFO - Получено 0 задач из REST-сервиса
13:19:00 - scheduler - INFO - Текущее количество задач в планировщике: 1
13:19:00 - scheduler - INFO - ID задач из REST-сервиса: set()
13:19:00 - scheduler - INFO - Проверяем задачу планировщика: update_jobs_from_rest
13:19:00 - scheduler - INFO - Обновление списка задач успешно завершено
```

#### Особенности реализации
- Интервал обновления: 1 минута
- Асинхронное взаимодействие с REST-сервисом
- Сохранение состояния между обновлениями
- Логирование всех этапов процесса
- Обработка ошибок и восстановление

#### Компоненты системы
1. Планировщик (cron_service)
   - Управление задачами
   - Синхронизация с REST-сервисом
...
### Сценарий 2: Запрос событий календаря
