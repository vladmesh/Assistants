...
1. [ ] Создание скрипта миграции данных из JSON в PostgreSQL
   - [ ] Проверка целостности данных перед миграцией
   - [ ] Создание бэкапа JSON файлов
   - [ ] Написание скрипта миграции
   - [ ] Тестирование миграции на тестовых данных

2. [ ] Валидация данных после миграции
   - [ ] Сравнение количества записей
   - [ ] Проверка связей между сущностями
   - [ ] Валидация обязательных полей

### Этап 3: Переключение сервисов
1. [ ] Миграция сервиса ассистентов
   - [ ] Добавление клиента для работы с REST API
   - [ ] Создание прокси-класса для работы с данными
   - [ ] Постепенное переключение на использование REST API
   - [ ] Тестирование каждого изменения

2. [ ] Миграция сервиса инструментов
   - [ ] Добавление клиента для работы с REST API
   - [ ] Создание прокси-класса для работы с данными
   - [ ] Постепенное переключение на использование REST API
   - [ ] Тестирование каждого изменения

3. [ ] Миграция сервиса задач
   - [ ] Добавление клиента для работы с REST API
   - [ ] Создание прокси-класса для работы с данными
   - [ ] Постепенное переключение на использование REST API
   - [ ] Тестирование каждого изменения
