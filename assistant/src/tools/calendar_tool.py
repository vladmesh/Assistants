...
class ListEventsRequest(BaseModel):
    ...
    time_min: Optional[datetime] = Field(None, description="Start time for event search")
...
class CalendarCreateTool(BaseTool):
    ...
    DESCRIPTION: ClassVar[str] = """Создает новое событие в Google Calendar.
...
class CalendarListTool(BaseTool):
    ...
    DESCRIPTION: ClassVar[str] = """Получает список событий из Google Calendar.
