...
class TestSecretaryLLM:
    ...
    async def test_basic_conversation(self):
        ...
        assert any(word in last_message.lower() for word in ["зовут", "имя", "называть", "assistant", "ассистент"]) 
    ...
    async def test_assistant_with_subassistant(self):
        ...
        assert len(mock_sub_assistant.calls) == 2  # Должен быть вызван для двух технических вопросов
